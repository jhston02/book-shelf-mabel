          ...
          testList
              ...
              [ testCase "Start reading wanted book returns ok"
                ...
                <| fun _ ->
                    ...
                    let result =
                        Result.defaultValue (([], BookInfo.Default), book) (Book.startReading book)
          ...
          testList
              ...
              [ testCase "Finish reading wanted book returns ok"
                ...
                <| fun _ ->
                    ...
                    let result =
                        Result.defaultValue (([], BookInfo.Default), book) (Book.finishReading book)
          ...
          testList
              ...
              [ testCase "Quit reading wanted book returns ok"
                ...
                <| fun _ ->
                    ...
                    let result =
                        Result.defaultValue (([], BookInfo.Default), book) (Book.quitReading book)
          ...
          testList
              ...
              [ testCase "Want to read dnf book returns ok"
                ...
                <| fun _ ->
                    ...
                    let result =
                        Result.defaultValue (([], BookInfo.Default), book) (Book.wantToRead book)
